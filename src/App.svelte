...
<div class="image-container">
  ...
  <!-- Definiere anklickbare Bereiche -->
  <div
    onclick={handleAmpleClick}
    class="clickable-area"
    style="top: 280px; left: 340px; width: 35px; height: 50px;"
  ></div>
  <div
    onclick={handleZebraClick}
    class="clickable-area"
    style="top: 330px; left: 370px; width: 250px; height: 70px;"
  ></div>
  <div
    onclick={handleBordsteinClick}
    class="clickable-area"
    style="top: 335px; left: 250px; width: 100px; height: 70px;"
  ></div>
   <div
    onclick={handleBusClick}
    class="clickable-area"
    style="top: 180px; left: 0px; width: 200px; height: 160px;"
  ></div>
  <div
    onclick={handleSchotterClick}
    class="clickable-area"
    style="top: 70px; left: 475px; width: 120px; height: 50px;"
  ></div>
